// ================================================================
// MathUniverse — parent.js
// ----------------------------------------------------------------
// Điều khiển TOÀN BỘ trang parent.html — trang RIÊNG cho phụ huynh,
// tách khỏi giao diện học sinh (index.html). Phụ huynh đăng nhập ở
// index.html rồi được auth-ui.js chuyển thẳng vào đây (xem
// onAuthenticated trong auth-ui.js) — không đi qua navbar học sinh.
//
// File này KHÔNG phụ thuộc app-core.js/curriculum.js/quiz.js — trang
// parent.html nạp độc lập, chỉ gọi thẳng api/auth.php + api/parent.php.
// ================================================================
(function () {
    ...
    // Mỗi con gắn 1 màu cố định (theo id) để phân biệt nhanh bằng mắt —
    // dùng chữ cái đầu tên thay vì icon con vật (giữ điềm tĩnh hơn giao
    // diện học sinh, nhưng vẫn theo đúng bảng màu thương hiệu).
