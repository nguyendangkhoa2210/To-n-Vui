...
// ========================= svg-shapes.js =========================
// ----------------------------------------------------------------
// Hàm dựng HÌNH ẢNH THẬT (SVG) và DÃY VẬT THỂ (emoji) cho các bài
// luyện tập. Khác với formulas.js cũ (chỉ vẽ minh họa sau khi máy
// tự tính), các hàm ở đây được engine luyện tập gọi TRƯỚC khi học
// sinh làm bài — hình luôn có sẵn, số liệu ẩn trong đề, học sinh
// phải tự quan sát/tính rồi gõ đáp số.
// ================================================================

// ---------- Dãy vật thể (dùng cho phép cộng/trừ trực quan Lớp 1-2) ----------
...
// Trục số minh họa "số liền trước / số liền sau": vẽ 5 ô liên tiếp quanh
// số n, tô vàng ô n (số đã biết) và tô hồng + dấu "?" ở ô cần tìm, có mũi
// tên chỉ hướng trái/phải để học sinh nhìn hình là hiểu ngay, không cần đọc
// giải thích bằng chữ.
